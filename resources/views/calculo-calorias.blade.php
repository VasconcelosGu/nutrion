...
<body>
    ...
    <section class="calculo-nutrientes">
        <div class="calculo-nutrientes-container">
            ...
            <p class="texto-grande g700">
                Digite o alimento que deseja e digite a quantidade para saber os valores nutricionais do mesmo
            </p>
                    ...
                    <ul class="nutrientes-lista">
                        ...
                        <li>
                            <div class="qtde-total-calorias">
                                ...
                                <div class="calc-calorias-res" id="calc-carbs-res">
                                    <p class="texto-grande"></p>
                                </div>
                        </li>
                        <li>
                            <div class="qtde-total-calorias">
                                ...
                                <div class="calc-calorias-res" id="calc-proteinas-res">
                                    <p class="texto-grande"></p>
                                </div>
                        </li>
                        <li>
                            <div class="qtde-total-calorias">
                                ...
                                <div class="calc-calorias-res" id="calc-gorduras-res">
                                    <p class="texto-grande"></p>
                                </div>
                        </li>
                    </ul>
    ...
    @vite(['resources/js/menu.js', 'resources/js/calculo-nutrientes.js'])
