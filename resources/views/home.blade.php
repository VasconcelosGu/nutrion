      ...
      <div class="calculos-container">
        ...
        <div class="tipo-calculo">
          ...
          <div class="tipo-calculo-texto">
            <p class="texto-grande g700">
              O cálculo de nutrientes de um alimento é feito com base em sua
              composição nutricional, como informações sobre os
              macronutrientes (calorias, proteínas, carboidratos e gorduras) e os
              micronutrientes (vitaminas e minerais) presentes no alimento.
            </p>
            <p class="texto-grande g700">
              Existem diferentes métodos para calcular os nutrientes de um
              alimento, mas um dos mais comuns é através da utilização de
              tabelas nutricionais. Essas tabelas fornecem informações
              detalhadas sobre a quantidade de nutrientes presentes
